...
<head>
	...
	<title>Decryptio Ico Watch</title>
	<!-- Bootstrap CSS -->
...
<body style="background: black;background: linear-gradient(black 0%, #450f57, #23072c, black)">
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-container">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="" class="hidden-md hidden-sm"><span class="glyphicon glyphicon-globe"></span> Ico Watch</a></li>
...
<div class="container-fluid" style="margin-top:1px">
	<div class="row">
		<div class="col-lg-4 col-md-6 col-lg-push-4">
		    <div class="jumbotron" id="about" style="background: black">
				<h2 class="text-center" style="color:white;font-size:1.85em"><b>Live Icos</b></h2>
				<div id="headlines">
				    <div style="color:gold;font-size:1.3em">
				        <?php include 'includes/liveicolist.php'; ?>
					</div>
				</div><br />
			</div>
		</div>
		...
		<div class="col-lg-4 col-md-6 col-lg-pull-4" >
			<div class="jumbotron" style="background: black">
				<h2 class="text-center" style="color:white;font-size:1.85em"><b>Upcoming Icos</b></h2>
				<div id="headlines">
				    <div style="color:gold;font-size:1.3em">
				        <?php include 'includes/futicolist.php'; ?>
					</div>
				</div><br />
			</div>
		</div>
		...
		<div class="col-lg-4 hidden-md">
			<div class="jumbotron" style="background: black">
			    ...
			    <h2 class="text-center" style="color:white;font-size:1.85em"><b>Finished Icos</b></h2>
				<div style="color:gold;font-size:1.3em">
				        <?php include 'includes/finicolist.php'; ?>
				</div>
				<br /><br />
			</div>
		</div>
