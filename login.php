	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-container">
			<ul class="nav navbar-nav">
                ...
                <li class=""><a href="register.php"><span class="glyphicon glyphicon-ok"></span>Register</a></li>						
			</ul>	
		</div>
	</div>        
</nav><br />
		...
		<div class="col-lg-6 col-md-12 col-lg-push-3">
		    <div class="jumbotron" style="background: black">
				...
				<div class="panel panel-default">
		            <div class="panel-heading">Login - Please enter Email or Username, and Password.
					</div>
			        <div class="panel-body">
			            <form action="process/logprocess.php" method="POST">    
				            <div class="row">
					        ...
					        <div class="row">
					            <div class="col-xs-12 padding-top-10">
						            <button type="submit" class="btn btn-success col-xs-4"style="margin-left:34%;margin-right:33%;" >Login</button>  
						        </div>
					        </div>
				        </form>
			        </div>
