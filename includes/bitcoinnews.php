...
// Fetch news
$news = fetchKyword($dbh, 'Bitcoin', 'btc', 'bitcoin');
...
<div class="row">
		...
		<div class="container" style='margin: 0% 0% 1.5% 0%;padding: 0% 0% 0% 0%'>
		    ...
		    <div class="col-lg-12 col-md-12 col-lg-push-0" align="center">
		        <div class="container" style='margin: 0% 0% .5% 0%;padding: 1% 0% 0% 0%'>
					<a class="headline" style="color:gold;font-size:1.1em;margin: 0px 0px 0px 0px" href="<?= $news[0]->web_link; ?>" target="_blank"><span class="glyphicon glyphicon-hand-right" style="color:gold;font-size:.8em"></span> <?= stripslashes($news[0]->news_title); ?></a>			
			    </div>
		    ...
		    <div class="col-lg-12 col-md-12 col-lg-push-0" align="center">
		        <div class="container" style='margin: 0% 0% 1.5% 0%;padding: 0% 0% 0% 0%'>
					<span class="headline" style="color:white;font-size:.95em;font-style: italic;margin: 0% 0% 0% 5%;padding: 0% 0% 0% 0%" href="<?= $news[0]->web_link; ?>" target="_blank"><?= stripslashes($news[0]->news_short_description); ?></span>
			    </div>
		    </div>		
    ...
    foreach ($news as $key => $article) :
		if	($article->news_title != $news[0]->news_title){?>		
